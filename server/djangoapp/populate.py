...
def initiate():
    car_make_data = [
        {"name": "NISSAN", "description": "Great cars. Japanese technology", "year_founded": 1933},
        {"name": "Mercedes", "description": "Great cars. German technology", "year_founded": 1926},
        {"name": "Audi", "description": "Great cars. German technology", "year_founded": 1910},
        {"name": "Kia", "description": "Great cars. Korean technology", "year_founded": 1944},
        {"name": "Toyota", "description": "Great cars. Japanese technology", "year_founded": 1937},
    ]

    car_make_instances = []
    for data in car_make_data:
            car_make_instances.append(CarMake.objects.create(name=data['name'], description=data['description'],year_founded=data['year_founded']))
